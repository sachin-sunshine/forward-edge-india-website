      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-14">
          <div className="max-w-xl">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-[#14213D] leading-tight mb-3">
              Case Studies
            </h2>
          ...
          <a
            href="#contact"
            className="self-start md:self-auto inline-flex items-center gap-2 text-[#FF8C00] border border-[#FF8C00] hover:bg-[#FF8C00] hover:text-[#14213D] font-semibold text-sm px-5 py-2.5 rounded-sm transition-all duration-200 whitespace-nowrap"
          >
            Discuss a Project
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
          {caseStudies.map((cs, idx) => (
            <div
              key={cs.title}
              className="group flex flex-col bg-white border border-slate-200 rounded-sm overflow-hidden hover:border-[#FF8C00]/40 hover:shadow-xl hover:shadow-slate-200/80 hover:-translate-y-1 transition-all duration-300"
            >
              {/* Card header */}
              <div className={`bg-gradient-to-br ${cs.color} bg-[#14213D] px-6 pt-6 pb-5 border-b border-slate-100`}>
                <div className="flex items-start justify-between gap-3 mb-3">
                  <span className="inline-block bg-[#FF8C00]/15 border border-[#FF8C00]/30 text-[#FF8C00] text-xs font-semibold px-2.5 py-1 rounded-sm tracking-wide">
                    {cs.tag}
                  </span>
                ...
                <h3 className="text-[#14213D] font-bold text-lg leading-snug group-hover:text-[#14213D] transition-colors">
                  {cs.title}
                </h3>
              </div>
              ...
              <div className="flex flex-col flex-1 p-6">
                ...
                {/* Outcomes */}
                <div className="mb-5">
                  <h4 className="text-xs font-bold text-[#14213D] uppercase tracking-wider mb-3">
                    Key Outcomes
                  </h4>
                  <ul className="space-y-2">
                    {cs.outcomes.map((outcome) => (
                      <li key={outcome} className="flex items-start gap-2.5 text-sm text-slate-600">
                        <svg className="w-4 h-4 text-[#FF8C00] flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
