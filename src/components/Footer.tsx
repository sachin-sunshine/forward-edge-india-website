          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="flex gap-3">
              ...
              <a
                href="#"
                aria-label="LinkedIn"
                className="w-9 h-9 rounded-sm border border-white/10 hover:border-[#FF8C00] hover:text-[#FF8C00] text-slate-500 flex items-center justify-center transition-all duration-200"
              >
            ...
            <ul className="space-y-3">
              {quickLinks.map((link) => (
                <li key={link.label}>
                  <a
                    href={link.href}
                    className="text-slate-500 hover:text-[#FF8C00] text-sm transition-colors flex items-center gap-1.5 group"
                  >
                    <span className="h-px w-3 bg-slate-700 group-hover:bg-[#FF8C00] group-hover:w-5 transition-all duration-200" />
                    {link.label}
                  </a>
                </li>
              ))}
